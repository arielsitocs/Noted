...
function CreateNote({ status, setStatus }) {
    ...
    if (status)
        return (
            <div className="create-note-modal" style={{ backgroundColor: noteColor }}>
                ...
                <div className="middle-row">
                    ...
                    <div className="note-description">
                        ...
                        <textarea type="text" id='description' placeholder='Ej: No alimentar con pedigree, la ultima vez se intoxicó!' />
                    </div>
                </div>
                <div className="bottom-row">
                    <button id='create-note'>CREAR</button>
